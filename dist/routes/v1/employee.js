...
router.post("/assign-role", employee_1.EmployeeController.assignRoleToEmployee);
// Set permissions for a role
router.post("/set-permissions", employee_1.EmployeeController.setRolePermissions);
