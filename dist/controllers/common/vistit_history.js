...
class VisitHistoryController {
    ...
    createVisit(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                console.log("Request received at createVisit");
    ...
    getAllByPatientId(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return (0, handle_response_1.sendError)(res, "Failed to fetch visit histories", 500);
            }
        });
    }
    getById(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return (0, handle_response_1.sendError)(res, "Failed to fetch visit history", 500);
            }
        });
    }
    getByDate(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                ...
                return (0, handle_response_1.sendError)(res, "Failed to fetch visits by date", 500);
            }
        });
    }
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                return (0, handle_response_1.sendError)(res, "Failed to update visit history", 500);
            }
        });
    }
}
exports.default = new VisitHistoryController();
