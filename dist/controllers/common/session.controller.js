...
exports.getSessionsHandler = (0, catchErrors_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (0, handle_response_1.sendSuccess)(res, {
        ...
        data: sessions.map((session) => (Object.assign(Object.assign({}, session), { is_current_session: session.id === req.payload.session_id }))),
    });
}));
exports.deleteSessionHandler = (0, catchErrors_1.default)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    return (0, handle_response_1.sendSuccess)(res, { message: "Session removed" });
}));
