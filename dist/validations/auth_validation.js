...
exports.registerSchema = zod_1.z.object({
    ...
    contact: zod_1.z.string().min(10, "Contact is required"),
    image: zod_1.z.string().optional(),
    secondary_contact: zod_1.z.string().min(10, "Contact is required").optional(),
    ...
    pincode: zod_1.z.string().min(6, "Invalid pin code"),
    ...
    plan: zod_1.z.string(),
    access_level: zod_1.z.enum(["GOD", "ADMIN", "READ", "WRITE", "MODIFY"]).optional(),
    userAgent: zod_1.z.record(zod_1.z.any()).optional(),
});
